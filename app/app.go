...
var (
	...
	maccPerms = map[string][]string{
		...
		taskstypes.ModuleName:          {authtypes.Burner},
...
func New(
	...
	*/
	...
	app.PortalchainKeeper = *portalchainmodulekeeper.NewKeeper(
		...
		keys[portalchainmoduletypes.MemStoreKey],
		app.GetSubspace(portalchainmoduletypes.ModuleName),
	)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(portalchainmoduletypes.ModuleName)
